          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 mb-16 mt-16 md:mt-24">
            ...
            <div className="flex-1 min-w-0 h-72 md:h-80 flex flex-col justify-between">
              ...
              <div className="flex flex-wrap items-center gap-4 md:gap-6 pt-4 pb-8">
                <a href="https://scholar.google.com/citations?user=r6OBQqgAAAAJ&hl=en" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-slate-800 hover:scale-110 active:scale-95 transition-all duration-200 inline-block" aria-label="Google Scholar">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="/icons/Google_Scholar_logo.svg" alt="" className="h-6 w-auto object-contain" />
                </a>
                <a href="https://orcid.org/0000-0001-9506-8742" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-slate-800 hover:scale-110 active:scale-95 transition-all duration-200 inline-block" aria-label="ORCID">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="/icons/ORCID_logo.svg" alt="" className="h-4 w-auto object-contain" />
                </a>
                <a href="https://www.scopus.com/authid/detail.uri?authorId=57204126093" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-slate-800 hover:scale-110 active:scale-95 transition-all duration-200 inline-block" aria-label="Scopus">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="/icons/Scopus_logo.svg" alt="" className="h-4 w-auto object-contain" />
                </a>
                <a href="https://www.semanticscholar.org/author/Yoonjung-Yoonie-Joo/3466689" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-slate-800 hover:scale-110 active:scale-95 transition-all duration-200 inline-block" aria-label="Semantic Scholar">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
